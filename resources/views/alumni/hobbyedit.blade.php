...
<hr>
  ...
  <form method="POST" action="{{route('hobbies.update', $hobby->id)}}" enctype="multipart/form-data">
		      ...
		      <div class="form-group col-md-10 col-md-offset-2"> 
		        ...
		        <textarea type="text" class="form-control input-lg" id="body" name="body" rows="5" style="resize:none; overflow-y: hidden; overflow-x: hidden;">{{ $hobby->body }}</textarea>
		      </div>
		     	<div class="col-md-10 col-md-offset-2">
		     		 <img src="{{ asset('images/'. $hobby->image)}}" width="600" height="400">
