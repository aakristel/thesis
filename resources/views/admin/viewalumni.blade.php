<!DOCTYPE html>
<html>
<title>Alumni | Profile User</title>
<meta charset="UTF-8">
...
<hr>
  ...
  <div class="w3-padding-60 w3-large w3-text-grey" style="font-weight:bold; color: black">
    ...
    <a href="/updateprofileuser/{{$user->id}}" class="w3-bar-item w3-button"><i class="fa fa-user" aria-hidden="true"></i> Update User</a>


    <a href="/alumnitable" class="w3-bar-item w3-button">>>Back</a><button class="btn btn-danger btn-block" data-toggle="modal" data-target="#deletemodal">Delete</button></li>
  </div>
</nav>
...
<div class="w3-main" style="margin-left:250px">
  ...
  <header class="w3-container w3-xlarge" id="one">
    ...
    <p class="w3-left" ">
      <p><i class="fa fa-bookmark" aria-hidden="true" style="color: rgba(29, 43, 83, 0.89)"></i> Course: {{ $user->course }} </p>
      <p><i class="fa fa-graduation-cap" aria-hidden="true" style="color: rgba(29, 43, 83, 0.89)"></i>  Year Graduated:{{ $user->yeargrad }}</p>
      ...
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          ...
          <div class="modal-footer">
             ...
             <form method="POST" action="{{ route('viewalumni.destroy', $user->id) }}">
